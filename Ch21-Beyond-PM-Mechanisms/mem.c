...
// Program that allocayes an array of ints of certain size. 
...
int main(int argc, char* argv[]){
  ...
  printf("%f seconds has elasped\n", t1);
  // if (argc != 2){
  //   fprintf(stderr, "usage: spin <memory (MV)>\n");
  //   exit(1);
  // }
  ...
  // // Now the main loop: each time through, touch each integer and increment its value by 1 
  // long long int i = 0;
  ...
  //   // If we've gone through the whole loop, reset a bunch of stuff and then perhaps print out some statistics. 
  //   if (i == num_ints){
